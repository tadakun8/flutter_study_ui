...
class _$ApiResponseTearOff {
  ...
  _ApiResponse call(List<Todo>? todos) {
    return _ApiResponse(
      todos,
    );
  }
...
class _$_ApiResponse with DiagnosticableTreeMixin implements _ApiResponse {
  const _$_ApiResponse(this.todos);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ApiResponse(todos: $todos)';
  }
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse(List<Todo>? todos) = _$_ApiResponse;
